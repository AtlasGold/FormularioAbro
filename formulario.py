...
if paginaselec == ("Cadastro"):
 ...
 with st.form(key="form1"):
  ...
  proximo = st.form_submit_button("proximo",)
 #botao_1 = st.button("Prosseguir")
...
if paginaselec == ("Saúde") :
 with st.form(key="form2"):
  ...
  proximo1 = st.form_submit_button("proximo")
#botao_2 = st.button("proximo")
 st.write(proximo1)

if paginaselec == ("Pessoais"):
# if proximo1 ==True:
  st.title("Sobre Você")
